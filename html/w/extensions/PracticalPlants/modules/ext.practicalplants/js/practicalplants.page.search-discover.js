...
function init(){
	$('#search-discover').discover( getOptions() );
}
...
function performImageRequests(){
	...
	$.get('http://practicalplants.local/w/api.php?action=query&titles='+values.join('|')+'&prop=imageinfo&iiurlwidth=200&iiprop=url&format=json')
