...
class PracticalPlants{
	...
	function plantName($parser,$name){
	...
	/* Format a plant name */
	function formatSpeciesName($name,$options=array()){
		$settings = array(
...
/*
	...
	*/
	...
	function changeCase($parser,$type,$string){
	...
	function setSpeciesChildName(&$mTarget, $query ){
	...
	function linkBegin($dummy, $target, $options, &$html, $attribs, $ret){
	...
	function linkEnd($dummy, $target, $options, $html, $attribs, $ret){
